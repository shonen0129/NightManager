...
def main():
    ...
    parser.add_argument("--gap-dir", default="live/pipeline_data/gap_adjusted_distribution/20260731_024303")
    ...
    parser.add_argument("--output-dir", default="results/v2_backtest_exact_production")
