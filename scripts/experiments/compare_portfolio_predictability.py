...
def main() -> int:
    false_csv = ROOT / "live/pipeline_data/gap_adjusted_distribution/20260731_024303/portfolio_gap_distribution_diagnostics.csv"
    true_csv = ROOT / "live/pipeline_data/gap_adjusted_distribution/20260731_025246/portfolio_gap_distribution_diagnostics.csv"
