#!/usr/bin/env python3
"""Run expanded 1620-stock subsector BLPX signal and evaluate aggregated IC.

Same as run_subsector_ic.py but uses the 1620-stock expanded mapping/panels.

Outputs:
  reports/subsector_refinement/phase2_blpx/subsector_ic_report_expanded.md
"""
...
def main() -> int:
    # Load 79-dim df_exec
    df_exec_sub = pd.read_parquet(ROOT / "var" / "research" / "subsector" / "df_exec_subsector_expanded_vw.parquet")
    ...
    with open(out_dir / "subsector_ic_summary_expanded.json", "w", encoding="utf-8") as f:
        json.dump(summary, f, ensure_ascii=False, indent=2)

    report_lines = [
        "# Phase 2: Subsector BLPX IC Evaluation (Expanded 1620-stock)",
    ...
    (out_dir / "subsector_ic_report_expanded.md").write_text("\n".join(report_lines), encoding="utf-8")
