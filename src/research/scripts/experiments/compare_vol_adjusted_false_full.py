...
def main() -> int:
    base_gap_dir = ROOT / "var/outputs/long_period/gap_adjusted_true/20260730_111327"
    new_gap_dir = ROOT / "var/outputs/long_period/gap_adjusted_false/20260730_111327"
    ...
    record_backtest_experiment(
        ...
        hypothesis="Full-period comparison: baseline gap-adjusted distribution.",
    ...
    record_backtest_experiment(
        ...
        hypothesis="Full-period comparison: vol_adjusted_target=false mu_gap.",
        app_config=app_config,
        results=new_res,
        decision=Decision.PENDING,
    )
