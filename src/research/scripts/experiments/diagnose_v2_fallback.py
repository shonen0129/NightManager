...
def main() -> int:
    gap_dir = ROOT / "var/outputs/long_period/gap_adjusted_false_clipped/20260730_173341"
    ...
    record_simple_experiment(
        ...
        hypothesis="Diagnose why V2 fallback remains for specific dates after Step 2 clipping.",
