...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--gap-input-dir", default="var/live/pipeline_data/gap_adjusted_distribution/20260731_024303")
    p.add_argument("--shadow-root", default="var/shadow_runs/v2_production_20200106_20260729")
