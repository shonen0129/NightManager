...
def run_ruled_rolling_calibration(
    ...
    w_ruled_df.multiply(df_exec["jp_oc_1617.T"].reindex(valid_dates_beta).fillna(0.0), axis=0).sum(axis=1) # dummy fallback
