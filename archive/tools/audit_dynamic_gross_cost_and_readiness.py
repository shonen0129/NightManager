...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Residual-BLPX Dynamic Gross Cost and Readiness Audit")
...
def main():
    ...
    df_score[df_score["rule"] == "RuleA"]["average_readiness_score"].values[0]
    df_score[df_score["rule"] == "RuleD"]["average_readiness_score"].values[0]
    df_score[df_score["rule"] == "RuleE"]["average_readiness_score"].values[0]
    df_score[df_score["rule"] == "RuleF"]["average_readiness_score"].values[0]
    df_score[df_score["rule"] == "RuleB"]["average_readiness_score"].values[0]

    df_score[df_score["rule"] == "RuleA"]["readiness_classification"].values[0]
    df_score[df_score["rule"] == "RuleD"]["readiness_classification"].values[0]
    df_score[df_score["rule"] == "RuleE"]["readiness_classification"].values[0]
    df_score[df_score["rule"] == "RuleF"]["readiness_classification"].values[0]
    df_score[df_score["rule"] == "RuleB"]["readiness_classification"].values[0]

    df_perf[(df_perf["rule"] == "Fixed") & (df_perf["cost_variant"] == "v2_10bps_per_gross")].iloc[0]
    df_perf[(df_perf["rule"] == "RuleA") & (df_perf["cost_variant"] == "v2_10bps_per_gross")].iloc[0]
    df_perf[(df_perf["rule"] == "RuleD") & (df_perf["cost_variant"] == "v2_10bps_per_gross")].iloc[0]
    df_perf[(df_perf["rule"] == "RuleE") & (df_perf["cost_variant"] == "v2_10bps_per_gross")].iloc[0]
