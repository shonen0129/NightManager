...
def main():
    ...
    df_align["cost"].values
    df_align["gross_return"].values
    ...
    next(r for r in summary_records if r["rule"] == "RuleF" and r["missing_day_treatment"] == primary_tr)
