...
from leadlag.execution.var_history import (
    get_hist_returns_for_risk as _get_hist_returns_for_risk,
)
...
@contextmanager
def _exclusive_lock(lock_path: str) -> Iterator[None]:
...
class PrecomputedLeadLagStrategy:
    ...
    def __init__(
        ...
        def _resolve_value(key: str, override: Any, default: Any) -> Any:
    ...
    def _resolve_trade_index(self, trade_date: str | pd.Timestamp | None) -> tuple[int, pd.Timestamp]:
