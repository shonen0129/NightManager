...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--shadow-root", default="var/shadow_runs/residual_blpx", help="Root directory of shadow runs")
    parser.add_argument("--gap-input-dir", default=None, help="Gap-adjusted distribution directory (realized returns source)")
    parser.add_argument("--output-dir", default="var/results/production_shadow_monitoring", help="Output directory for monitoring results")
