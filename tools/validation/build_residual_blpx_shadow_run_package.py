...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--gap-input-dir", default="var/results/gap_adjusted_distribution/20260615_004202", help="Step 2 gap distribution folder")
    parser.add_argument("--ranking-audit-dir", default="var/results/risk_adjusted_ranking_audit/20260615_120049", help="Step 4.5 audit directory")
    parser.add_argument("--covariance-audit-dir", default="var/results/covariance_optimization_audit/20260615_123718", help="Step 5.5 audit directory")
    parser.add_argument("--dynamic-gross-dir", default="var/results/dynamic_gross_validation/20260615_030352", help="Step 3 dynamic gross directory")
    parser.add_argument("--cost-audit-dir", default="var/results/dynamic_gross_cost_audit/20260615_031123", help="Step 3.5 cost audit directory")
    parser.add_argument("--vol-state-panel", default="var/results/vol_state_diagnostics/20260614_115821/state_panel.csv", help="US Vol State Panel CSV path")
    parser.add_argument("--output-dir", default="var/results/production_shadow_run_package", help="Output directory")
    parser.add_argument("--shadow-root", default="var/shadow_runs/residual_blpx", help="Shadow runs root folder")
...
def main():
    ...
    weights_file = Path("var/results/production_residual_blpx_validation/daily_positions_Residual-BLPX_only.csv")
