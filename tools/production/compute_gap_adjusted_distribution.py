...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--distribution-input-dir", default="live/pipeline_data/distribution_diagnostics/20260708_184812", help="Step 1 diagnostics input directory")
    parser.add_argument("--validation-input-dir", default="live/pipeline_data/distribution_validation/20260614_235912", help="Step 1 validation input directory")
